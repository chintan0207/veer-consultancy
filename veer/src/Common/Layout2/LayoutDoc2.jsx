...
const LayoutDoc2 = () => {
  ...
  const handleNextStage = (
    ...
    validateForm().then((errors) => {
      if (
        Object.keys(errors).some((field) => nextStageFields.includes(field))
      ) {
        setTouched(
          nextStageFields.reduce(
                ...
                <>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-error">
                      ...
                      >
                        ...
                        <option value="Retired Goverment Servant">
                          Retired Government Servant
                        </option>
                        <option value="Student">Student</option>
                        <option value="Self-Employed">Self-Employed</option>
                        <option value="Retired-Private Service">
                  ...
                  <div className="form-group">
                    ...
                    <div className="radio-group">
                      ...
                      <label>
                        <Field type="radio" name="serviceType" value="tatkal" />
                        Emergency
                      </label>
                    </div>
                    <ErrorMessage
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      handleNextStage(validateForm, setTouched, "stage2", [
                        "name",
                        "motherName",
                        "placeOfBirth",
                        "serviceType",
              ...
              {layout === "stage2" && (
                <>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-error">
                      <Field
                        ...
                        id="policeStation"
                        name="policeStation"
                        placeholder="Enter your area police station"
                      />
                      <ErrorMessage
                        name="policeStation"
                        component="div"
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      handleNextStage(validateForm, setTouched, "stage3", [
                        "email",
                        "mobileNo",
                        "alterMobileNo",
                        "policeStation",
              ...
              {layout === "stage3" && (
                <>
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      handleNextStage(validateForm, setTouched, "stage4", [
                        "identityProof",
                        "birthProof",
                        "addressProof",
                      ])
                  ...
                  <div className="preview-section">
                    <div className="details">
                      <div className="stype-amount">
                        <p>
                          <strong>ServiceType :</strong> {values.serviceType}
                        </p>
                        <p>
                          <strong>Amount to be Paid :</strong>{" "}
                          {values.serviceType === "tatkal" ? 3000 : 1}
                        </p>
                      </div>
                      <p>
                      ...
                      <p>
                        <strong>Mother's Name:</strong> {values.motherName}
                      </p>
                      <p>
                        <strong>Place of Birth:</strong> {values.placeOfBirth}
                      </p>
                      <p>
                    ...
                    <div className="details">
                      ...
                      <p>
                        <strong>Mobile No:</strong> {values.mobileNo}
                      </p>
                      <p>
                        <strong>Alternative Mobile No:</strong>{" "}
                        {values.alterMobileNo}
                      </p>
                      <p>
                        <strong>Police Station:</strong> {values.policeStation}
                      </p>
                    </div>
                    ...
                    <div className="details">
                      <div className="">
                        <p>
                          ...
                          {values.identityProof
                            ? values.identityProof.name
                            : "Not uploaded"}
                        </p>
                        <p>
                          <strong>Birth Proof:</strong>{" "}
                          {values.birthProof
                            ? values.birthProof.name
                            : "Not uploaded"}
                        </p>
                        <p>
