...
const Register = () => {
  const { setMsg, setSneck, setLoading, ropen, setRopen, setIsOpen, url } =
  ...
  const validationSchema = Yup.object({
    ...
    mobile: Yup.string("Enter your Mobile.No")
        ...
        >
          <Form className="register-form">
            ...
            <div className="register-page">
              ...
              <span onClick={() => setRopen(false) || setIsOpen(true)}>
                Login
              </span>{" "}
            </div>
          </Form>
